...
class PictureTooBig extends Exception
{
     ...
     */
    public function __construct($message = "The image you tried to upload doesn't fit the website criteria. We only accept files below 0,5 Mo", $code = "0007", $previous = null)
    {
